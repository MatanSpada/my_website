...
export function buildCaveEntrance(scene: Scene): WorldInfo {
  ...
  for (const [i, data] of [[-7,5.2,-7.8,5.2,7.4,4], [6.7,5,-7.8,5.6,7.2,4.2], [0,8,-8.2,10.5,4.4,4.5]].entries()) { const [x,y,z,w,h,d] = data; const mass = staticBox(scene, `mountain-mass-${i}`, x,y,z,w,h,d, stone); mass.rotation.y = (i - 1) * .18; }
